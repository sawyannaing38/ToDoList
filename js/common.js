...
function getTotalListItem(obj)
{
    ...
    item.innerHTML += `
        ...
        <span class="${obj.status} remind">${obj.status}</span>
    `;

    return item;
}
// Exporting
export { openMenu, closeMenu, getHomeListItem, showNoListsMessage, getTotalListItem };